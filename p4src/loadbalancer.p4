...
#define REGISTER_LB_SIZE 1024
#define REGISTER_FLOWLET_SIZE 8192
...
control MyIngress(inout headers hdr,
    ...
    register<bit<REGISTER_WIDTH>>(REGISTER_LB_SIZE) loadbalance_seed;
    register<bit<ID_WIDTH>>(REGISTER_FLOWLET_SIZE) flowlet_to_id;
    register<bit<TIMESTAMP_WIDTH>>(REGISTER_FLOWLET_SIZE) flowlet_time_stamp;
...
control MyEgress(inout headers hdr,
    ...
    register <bit<48>>(REGISTER_LB_SIZE) feedback_ts;
